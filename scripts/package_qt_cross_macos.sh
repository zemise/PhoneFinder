...
if [[ -f "${ROOT_DIR}/../build/windows/icon.ico" ]]; then
  cp -f "${ROOT_DIR}/../build/windows/icon.ico" "${STAGE_DIR}/icon.ico"
fi
if [[ -f "${ROOT_DIR}/../build/trayicon.png" ]]; then
  cp -f "${ROOT_DIR}/../build/trayicon.png" "${STAGE_DIR}/trayicon.png"
fi
